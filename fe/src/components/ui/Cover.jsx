...
export const Cover = ({ children, className }) => {
  ...
  return (
    <div
      ...
      ref={ref}
      className="relative hover:bg-neutral-900 group/cover inline-block dark:bg-black bg-cyan-900 px-2 py-2 transition duration-200 rounded-2xl"
    >
      <AnimatePresence>
        {hovered && (
          <motion.div
      ...
      <defs>
        <motion.linearGradient
          ...
          transition={{
            ...
            repeatDelay: hovered ? Math.random() * (2 - 1) + 1 : delay,
          }}
        >
